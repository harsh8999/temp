...
export class AnswerComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._apiServices.getActiveSurvey().subscribe(
      (data)=>{
        ...
        this.survey_id = element['id'];
        console.log("surveyID",this.survey_id)
        ...
        .subscribe(
          (data)=>{
            ...
            this.questions.forEach(question => {
              ...
              console.log("create Options",this.myForm.value)
            });
  ...
  this.myForm.get('survey_id').setValue(this.survey_id)
